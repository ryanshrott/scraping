...
class RealtorSpider(scrapy.Spider):
    ...
    payload = "ZoomLevel=11&LatitudeMax=43.99454&LongitudeMax=-79.05332&LatitudeMin=43.42026&LongitudeMin=-79.69945&Sort=6-D&PropertyTypeGroupID=1&PropertySearchTypeId=1&TransactionTypeId=2&Currency=CAD&CurrentPage=1&ApplicationId=1&CultureId=1&Version=7.0&RecordsPerPage=25"
    ...
    def modify_payload(self, page_number):
        self.payload = f'ZoomLevel=11&LatitudeMax=43.99454&LongitudeMax=-79.05332&LatitudeMin=43.42026&LongitudeMin=-79.69945&Sort=6-D&PropertyTypeGroupID=1&PropertySearchTypeId=1&TransactionTypeId=2&Currency=CAD&CurrentPage={page_number}&ApplicationId=1&CultureId=1&Version=7.0&RecordsPerPage=25'
